...
class Utilities(commands.Cog):
    ...
    async def iplookup(self, ctx, arg):
        ...
        embed.add_field(name="IP", value="Not available" or values['query'], inline=False)       
        embed.add_field(name="Country", value="Not available" or values['country'], inline=True)
        embed.add_field(name="Region", value="Not available" or values['regionName'], inline=True)
        embed.add_field(name="City", value="Not available" or values['city'], inline=True)
        embed.add_field(name="Latitude", value="Not available" or values['lat'], inline=True)
        embed.add_field(name="Longitude", value="Not available" or values['lon'], inline=True)
        embed.add_field(name="Timezone", value="Not available" or values['timezone'], inline=True)
