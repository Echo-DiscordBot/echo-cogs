...
class JoinMessage(commands.Cog):
    ...
    async def on_guild_join(self, guild):
        ...
        if not channel.permissions_for(guild.me).send_messages:
            return
        embed = discord.Embed(title="Thank you for inviting me.", description=msg) #,color=Hex code
        embed.add_field(name="Name", value="you can make as much as fields you like to")
        embed.set_footer(name="Send $help <command> or $helpcat <category> for more information on a command or category.\nEcho - A multipurpose Discord Bot - Made with ❤️ in Nepal 🇳🇵") #if you like to
